...
| Generation | 질문별 AnswerPoint를 코드에서 조합, 인용/숫자 기간/일부 실행 상태 검사, 실패 때 의미 재작성 1회 | 실제 개발셋에서 의미 오류/차단 관측. 운영 원문·독립 holdout·자연스러움 정량 평가는 NOT_RUN |
