...
def build_operator_guide() -> Path:
    ...
    add_steps(
        ...
        [
            ...
            "제목과 한국어 본문을 직접 고친다.",
            "서명을 고른다. 고르지 않으면 서명 없이 나간다 — 본문에는 서명이 없다.",
    ...
    add_table(
        ...
        [
            ...
            ("signature_*", "검토 화면에서 고르는 서명", "콘솔에서 추가·수정·삭제"),
            ("signature_*", "HTML 로 써도 되고 글로 써도 된다", "이미지는 공개 HTTPS URL"),
        ],
        [2200, 3600, 3560],
        font_size=8.7,
    )
