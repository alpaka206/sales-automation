...
| 발신 주소 | 지금 | **주소 이관 후(예상)** |
|---|---:|---:|
| `perso.ai@estsoft.com` | **85** (83%) | **103** (100%) |
| `support@perso.ai` | 16 | 0 |
| `support@45169260.hubspot-inbox.com` (기계 주소) | 2 | 0 |
| **합계** | **103** | **103** |
...
- 그중 2건은 `support@perso.ai` 조차 못 써서 **허브스팟이 자동 발급한 기계 주소**
  (`support@45169260.hubspot-inbox.com`)로 나갑니다. 고객이 받는 메일의 보낸사람이 그것입니다.
- 전체 B2B 티켓 100건 기준으로 **100건 모두 Inbox 인박스에 대화가 있고**, GTM Marketing 에만
  있는 티켓은 **0건**입니다. 그래서 옮길 방향은 Inbox 쪽입니다 — 옮기면 100%가 됩니다.
