...
const SECTIONS: Section[] = [
  ...
  },
  {
    title: "인사이트",
    icon: "bolt",
    // 「고객 인사이트」(손이 가야 하는 리드 목록 · 갱신 임박)가 있던 자리 — 운영자 지시(2026-09-15)로
    // 전부 빼고, 이 PC 의 스냅샷(제품 전체)에서 보는 「영업 인사이트」가 들어왔다. 주소는 그대로다.
    items: [
      { to: "/operations", label: "영업 인사이트", icon: "bell", mobileLabel: "인사이트" },
    ],
  },
  {
    title: "시스템",
