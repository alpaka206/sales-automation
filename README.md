...
3. 첫 문의에는 “곧 자세한 답변을 드리겠다”는 접수 확인 이메일을 즉시 보냅니다. 아래에는 Perso Dubbing 로고가 붙습니다 — 담당자 서명은 아직 붙지 않습니다. **자동 회신은 여기까지, 문의 하나에 한 번뿐입니다**: 같은 대화의 이후 고객 메시지는 기록만 되고 초안이 만들어지지 않습니다.
